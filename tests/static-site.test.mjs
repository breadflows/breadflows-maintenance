...
test("SIGNAL_404 keeps all extras outside its numbered episode sequence", async () => {
  const extras = ["unknown-bc02-signal-404", "project-the-rift-teaser", "breadflows-studio-signal-intro-53-sync-anomaly", "rose-petals-ressistance-neon-hunt-visualiser", "ink-between-worlds-soundtrack-visualiser", "xorvian-thal-unstable-transmission"];
